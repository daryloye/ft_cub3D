...
/*   Updated: 2024/11/06 02:03:48 by daong            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	do_movements(t_data *data)
{
	...
	if (data->keys[LEFT_ARROW])
		data->player->rot_deg = fmod((data->player->rot_deg - 0.1 + 6.28), 6.28);
	if (data->keys[RIGHT_ARROW])
		data->player->rot_deg = fmod((data->player->rot_deg + 0.1), 6.28);
